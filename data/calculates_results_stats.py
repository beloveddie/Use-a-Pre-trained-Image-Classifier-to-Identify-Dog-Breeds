...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # 5a. Count correctly classified dog breeds
        ...
        # 5b. Count correctly classified non-dog images
        else:
    ...
    # 5f. Return the results_stats_dic
